...
import { Address, Card, Customer } from "../plugins/db";
...
describe("CRUD de Cliente", function () {
  ...
  it("Cadastrar Cliente", function () {
    ...
    cy.get("input[name='cpf']").should("have.value", fakeCPF);
    ...
    cy.get("input[name='phoneNumber']").should("have.value", "987654321");
  ...
  it("Ver dados cadastrais do cliente", function () {
    cy.task<Customer>("db:createDemoCustomer").then((customer) => {
      ...
      cy.get("input[name='cpf']").should("have.value", customer.cpf);
  ...
  it("Editar dados cadastrais do cliente", function () {
    cy.task<Customer>("db:createDemoCustomer").then((customer) => {
      ...
      cy.get("input[name='cpf']").should("have.value", "01268095850");
